...
public class MensajeControllerE2ETests {
	...
	@WithMockUser(username = "patrocinador4", authorities = { "patrocinador" })
	@Test
	...
	@WithMockUser(username = "propietario1", authorities = { "patrocinador" })
	@Test
	...
	@WithMockUser(username = "propietario3", authorities = { "propietario" })
	@Test
	...
	@WithMockUser(username = "administrador", authorities = { "admin" })
	@Test
	...
	void testDetallesMensaje() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/mensajes/{mensajeId}", 4))
				.andExpect(MockMvcResultMatchers.status().is2xxSuccessful())
	...
	void testNegativoDetallesMensaje() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/mensajes/{mensajeId}", 15))
				.andExpect(MockMvcResultMatchers.status().is2xxSuccessful())
				.andExpect(MockMvcResultMatchers.view().name("exception"));
	}
